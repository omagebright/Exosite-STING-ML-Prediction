...
output_folder = 'string_processing'
os.makedirs(output_folder, exist_ok=True)

def save_result_to_csv(result, pdb_code, chain_name, number):
    # Create a unique filename based on pdb_code, chain_name, and number
    filename = f'{output_folder}/{pdb_code}_{chain_name}_{number}_result.csv'
...
merged_results.to_csv('train_exosite_sting_descriptors.csv', index=False)
